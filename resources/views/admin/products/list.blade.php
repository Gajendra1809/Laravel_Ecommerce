    ...
    <section class="content">
        ...
        <div class="container-fluid">
            <div class="card">
                ...
                <div id="session-message" class="alert alert-success alert-dismissible fade show" role="alert"
                    style="display: none;">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="javascript:void(0)"
                                                ...
                                                class="delete-product text-danger w-4 h-4 mr-1">
    ...
    <script>
        $(document).ready(function() {
            @if (session('flashMessage'))
                $('#session-message').text('{{ session('flashMessage') }}').show();
                setTimeout(function() {
