                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        ...
                        <picture>
                            ...
                            <source media="(min-width: 800px)"
                                srcset="{{ asset('frontend-assets/images/carousel-1.jpg') }}" />
                            <img src="{{ asset('frontend-assets/images/carousel-1.jpg') }}" alt="" />
                        </picture>
                    ...
                    <div class="carousel-item">
                        ...
                        <picture>
                            ...
                            <source media="(min-width: 800px)"
                                srcset="{{ asset('frontend-assets/images/carousel-2.jpg') }}" />
                    ...
                    <div class="carousel-item">
                        ...
                        <picture>
                            ...
                            <source media="(min-width: 800px)"
                                srcset="{{ asset('frontend-assets/images/carousel-3.jpg') }}" />
                            <img src="{{ asset('frontend-assets/images/carousel-2.jpg') }}" alt="" />
                        </picture>
